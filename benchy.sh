	...
	then	
		...
		then
			...
			then
				...
				for i in `ls *.html`; do /Users/moldfiel/zISC/600_Tools/pButtonsTools/yape/graph_pButtons.py ./${i}_metrics -p line_${i}_ -s line -t ${i}; done
				for i in `ls *.html`; do /Users/moldfiel/zISC/600_Tools/pButtonsTools/yape/graph_pButtons.py ./${i}_metrics -p dot_${i}_ -s dot -t ${i}; done
				for i in `ls *.html`; do /Users/moldfiel/zISC/600_Tools/pButtonsTools/yape/graph_pButtons.py ./${i}_metrics -p interactive_${i}_ -s interactive -t ${i}; done	
			fi			
		fi
